...
<img src="docs/assets/demo.gif" alt="Context Bridge quickstart: three agents share one memory pool and a fourth recalls only the relevant, budgeted slice" width="820">
...
<img src="docs/assets/demo.gif" alt="Context Bridge quickstart output — animated terminal recording" width="820">
